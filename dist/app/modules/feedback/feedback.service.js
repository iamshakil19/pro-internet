...
const createFeedback = (user, payload) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const result = yield prisma_1.default.feedback.create({ data: { userId: isUserExist.id, desc }, include: { user: true }, });
    return result;
});
